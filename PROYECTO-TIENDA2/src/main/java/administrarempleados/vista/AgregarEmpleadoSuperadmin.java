 ...
 *clase limitada solo al SuperAdmin, esta clase solo puede agregar administradores
 */
public class AgregarEmpleadoSuperadmin extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AgregarEmpleadoSuperadmin frame = new AgregarEmpleadoSuperadmin();
	...
	public AgregarEmpleadoSuperadmin() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					lblAgregadoEfectivo.setText("Datos Insertados correctamente");
					...
					lblAgregadoEfectivo
							.setText("No se pudo insertar los datos, verifique que el ID de ingreso sea valido.");
					e1.printStackTrace();
				}
		...
		cargoDesplegable.addItem("Administrador");
